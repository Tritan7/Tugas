...
import 'package:pert_5/configs/app_routes.dart';
...
class SearchFillWidget extends StatelessWidget {
  const SearchFillWidget({
    super.key,
  });
...
class LatestNewsIndexCardSelection extends StatelessWidget {
  const LatestNewsIndexCardSelection({
    super.key,
    required this.size,
  });
